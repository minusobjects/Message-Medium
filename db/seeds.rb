...
story5 = Story.create!(
  ...
  main_image: URI.parse("http://s3-us-east-2.amazonaws.com/message-dev/stories/main_images/000/000/005/original/nichols.jpeg?1492980631")
)
...
story6 = Story.create!(
  ...
  main_image: URI.parse("http://s3-us-east-2.amazonaws.com/message-dev/stories/main_images/000/000/006/original/chatbots.jpeg?1492983045")
)
